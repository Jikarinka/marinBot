    ...
    async execute(sock, m, msgData) {
        ...
        if (!text) {
            return sock.sendMessage(msgData.remoteJid, {
                text: 'Uwaaa! URL-nya mana kak? Kasih tahu Marin link yang mau diambil yaa~ (˶˃ ᵕ ˂˶)'
            }, { quoted: m });
        }
        ...
        try {
            ...
            // 2. Jika kontennya teks atau JSON
                ...
                if (txt.length > 4000) {
                    ...
                    await sock.sendMessage(msgData.remoteJid, { text: `Kontennya kepanjangan kak, jadi Marin kirim sebagai file yaa~ (˶˃ ᵕ ˂˶)` }, { quoted: m });
                } else {
            ...
            // 3. Jika kontennya HTML
                ...
                await sock.sendMessage(msgData.remoteJid, { text: 'Itu file HTML-nya sudah Marin ambilkan kak! (๑>ᴗ<๑)' }, { quoted: m });
            }
