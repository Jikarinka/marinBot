    ...
    async execute(sock, m, msgData) {
        ...
        if (!text) {
            return sock.sendMessage(msgData.remoteJid, {
                text: `Uwaaa! Kakak mau cari apa di YouTube? Kasih tahu Marin yaa~ (˶˃ ᵕ ˂˶)\n\nContoh: \`.${msgData.commandName} anime song\``
            }, { quoted: m });
        }
        ...
        try {
            ...
            if (videos.length === 0) {
                return sock.sendMessage(msgData.remoteJid, {
                    text: `Maafin Marin kak, video yang kakak cari nggak ketemu.. (｡T ω T｡)`
                }, { quoted: m });
            }
...
`.trim();
            ...
            await sock.sendMessage(msgData.remoteJid, {
                text: `Uwaaa gawat! Marin lagi pusing pas nyari video di YouTube kak.. (╥﹏╥)\n\n*Error:* ${error.message || 'Internal Server Error'}`
            }, { quoted: m });
        }
    }
};
